...
export class AssistantService {
    ...
    async create(assistantData: ICreateAssistant) {
        const newAssistant = new AssistantEntity()
        newAssistant.name = assistantData.name
        newAssistant.lastname = assistantData.lastname
        newAssistant.email = assistantData.email
        newAssistant.cellphone = assistantData.cellphone
        newAssistant.description = assistantData.description
        newAssistant.area = assistantData.area
